...
double precision, dimension(-1:nxf,-1:nyf)::r	!on higher grid
double precision, dimension(-1:nxh,-1:nyh)::f	!on lower grid
integer::i,j
integer::ireo
...
!---------------------------------------------------------------------------!
subroutine multigrid5(u_orig,f_orig,nx,ny,dx,dy,tol)
implicit none
...
end subroutine periodic_bc_update